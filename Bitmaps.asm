...
Printscore:
	...
	bitMaps: dw bitMap1, bitMap2, bitMap3, bitMap4, bitMap5, bitMap6, bitMap7, bitMap8, bitMap9
	...
	ClearABox:			; + 4 -- y co ordinate, + 6 x -- coordinate
		push bp
		mov  bp, sp
		pushA
		mov  cx, [bp + 6]
	...
	FrequencyArray: dw 9,9,9,9,9,9,9,9,9
